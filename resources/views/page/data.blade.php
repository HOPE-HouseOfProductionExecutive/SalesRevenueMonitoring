...
<script>
    ...
    window.operateEvents = {
        ...
        'click .remove': function (e, value, row, index) {
            ...
            switch (row.month) {
                case 1:
                    $('#table-month').html('January');
                    break;
                case 2:
                    $('#table-month').html('February');
                    break;
                case 3:
                    $('#table-month').html('March');
                    break;
                case 4:
                    $('#table-month').html('April');
                    break;
                case 5:
                    $('#table-month').html('May');
                    break;
                case 6:
                    $('#table-month').html('June');
                    break;
                case 7:
                    $('#table-month').html('July');
                    break;
                case 8:
                    $('#table-month').html('August');
                    break;
                case 9:
                    $('#table-month').html('September');
                    break;
                case 10:
                    $('#table-month').html('October');
                    break;
                case 11:
                    $('#table-month').html('November');
                    break;
                case 12:
                    $('#table-month').html('December');
                    break;
                default:
                    $('#table-month').html(row.month);
                    break;
            }
